 ...
 * our object with.
 * i.e we create a crate with an Elephant, type T will be an Elephant, which we would do in code with
 * {@code Crate<Elephant>eleBox=new Crate<Elephant>()}
...
//	private T contents=new T();
	 ...
	 * an elephant as in method Examples.ex1 we use as our type a Elephant
	 */
	...
	/**returns an object of whatever type we said T will be */
	public T returnT() {
		return contents;
	}
}
